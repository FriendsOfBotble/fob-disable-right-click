...
return [
    ...
    'settings' => [
        ...
        'enable_text_selection' => 'Inaktivera textval',
        'enable_text_selection_help' => 'Förhindra att användare väljer och kopierar text på din webbplats för upphovsrättsskydd.',
        'enable_devtools_detection' => 'Inaktivera utvecklarkonsol',
        'enable_devtools_detection_help' => 'Ladda om sidan automatiskt när utvecklarverktyg/konsol öppnas i webbläsaren.',
