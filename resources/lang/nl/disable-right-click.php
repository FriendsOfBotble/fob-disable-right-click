...
return [
    ...
    'settings' => [
        ...
        'enable_text_selection' => 'Tekstselectie uitschakelen',
        'enable_text_selection_help' => 'Voorkom dat gebruikers tekst op uw website selecteren en kopiëren voor auteursrechtbescherming.',
        'enable_devtools_detection' => 'Ontwikkelaarsconsole uitschakelen',
        'enable_devtools_detection_help' => 'Laad de pagina automatisch opnieuw wanneer ontwikkelaarstools/console worden geopend in de browser.',
