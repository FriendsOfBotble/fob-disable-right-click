...
return [
    ...
    'settings' => [
        ...
        'enable_text_selection' => 'Dezactivare selecție text',
        'enable_text_selection_help' => 'Împiedicați utilizatorii să selecteze și să copieze text pe site-ul dvs. pentru protecția drepturilor de autor.',
        'enable_devtools_detection' => 'Dezactivare consolă dezvoltator',
        'enable_devtools_detection_help' => 'Reîncărcați automat pagina când instrumentele dezvoltatorului/consola sunt deschise în browser.',
        'saved' => 'Setări salvate cu succes!',
    ],
];
