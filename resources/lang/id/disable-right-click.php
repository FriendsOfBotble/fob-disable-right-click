...
return [
    ...
    'settings' => [
        ...
        'enable_text_selection' => 'Nonaktifkan Pemilihan Teks',
        'enable_text_selection_help' => 'Mencegah pengguna memilih dan menyalin teks di situs web Anda untuk perlindungan hak cipta.',
        'enable_devtools_detection' => 'Nonaktifkan Konsol Pengembang',
        'enable_devtools_detection_help' => 'Muat ulang halaman secara otomatis ketika alat pengembang/konsol dibuka di browser.',
